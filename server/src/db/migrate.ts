...
--           byoa-codex|byoa-cursor — almost always 'cloud' here; BYOA local triages still
...
CREATE TABLE IF NOT EXISTS computers (
  ...
  available_engines JSONB NOT NULL DEFAULT '[]'::jsonb,    -- ['claude','codex','pi','cursor']; ['managed'] for cloud
...
ALTER TABLE participants ADD COLUMN IF NOT EXISTS engine      TEXT;  -- 'managed' | 'claude' | 'codex' | 'pi' | 'cursor'
