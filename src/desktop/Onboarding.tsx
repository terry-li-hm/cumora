      ...
      <main className="flex-1 overflow-y-auto grid place-items-center p-8"
        ...
        <div className="w-full max-w-[640px]">
          ...
          <p className="text-[14.5px] text-ink-600 leading-relaxed mb-6 max-w-[560px]">
            ...
            <span className="font-mono text-[13px]"> Grok Build</span>,
            <span className="font-mono text-[13px]"> pi</span>, or
            ...
            {!code ? (
              <>
                <div className="text-[13px] text-ink-600 mb-4">
                  ...
                  <span className="font-mono"> claude</span>, <span className="font-mono">codex</span>, <span className="font-mono">grok</span>, <span className="font-mono">pi</span>, or <span className="font-mono">cursor-agent</span> installed.
                </div>
