...
powered by your **local Claude Code, Codex, Grok Build, pi, or Cursor Agent CLI**
...
`pi`, or `cursor-agent` (Cursor) on your `PATH`. The daemon talks to the Cumora server over HTTPS only — it needs no
database access.
